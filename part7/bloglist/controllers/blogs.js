...
blogsRouter.post('/:id/comments', async(request, response) => {
    ...
    console.log('Blog comments array:', blog.comments)
    blog.comments.push(commentObj.comment)
    console.log('Updated comments of blog:', blog.comments)

    const latestComment = blog.comments.at(-1)
    console.log('Latest comment:', latestComment)

    await blog.save()

    // Send response back to client with all of the comments of a blog
